...
/**
 * This validator check Length after removing html tags
 * Class StripTagsLengthValidator
 * @package Store\BackendBundle\Validator\Constraints
 */
class StripTagsLengthValidator extends ConstraintValidator
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (!$constraint instanceof StripTagsLength) {
        ...
        $stringValue = (string)strip_tags($value);
